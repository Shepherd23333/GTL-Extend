...
//            builder.displayItems(new GTCreativeModeTabs.RegistrateDisplayItemsGenerator("machines_item", GTLEXRegistration.REGISTRATE))
...
//        }).register();
        ...
        BLOCKS_ITEM = GTLEXRegistration.REGISTRATE.defaultCreativeTab("blocks_item", (builder) -> {
            builder.displayItems(new GTCreativeModeTabs.RegistrateDisplayItemsGenerator("blocks_item", GTLEXRegistration.REGISTRATE))
        ...
        GTL_EX_GT_ITEM = GTLEXRegistration.REGISTRATE.defaultCreativeTab("gtl_ex_gt_item", (builder) -> {
            builder.displayItems(new GTCreativeModeTabs.RegistrateDisplayItemsGenerator("gtl_ex_gt_item", GTLEXRegistration.REGISTRATE))
