package cn.qiuye.gtlextend.data.lang;
...
public class LangProvider extends LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        provider.add("config.screen.gtl_extend", "GTL Extend config");
        ...
        provider.add("gtl_extend.machine.circuit", "Circuit configuration, %d (x%s power)");
        ...
        replace(provider, "itemGroup.gtl_extend.blocks_item", "GTL Extend Blocks");
        replace(provider, "itemGroup.gtl_extend.gtl_ex_gt_item", "GTL Extend Items");
        replace(provider, "itemGroup.gtl_extend.machines_item", "GTL Extend Machines");
